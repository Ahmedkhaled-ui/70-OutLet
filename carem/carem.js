...
function display() {
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    if (element.found === "كريم") {
      let felter = products.filter(
        (element) => element.found && element.found.includes("كريم")
      );
      ...
      <h1 class=" fs-6"> عدد المنتجات : <span class="text-success fw-bolder"> ${index}   </span> 
       <h2 class=" fs-6"> المديونية لدي كريم : <span class="text-danger fw-bolder"> ${sum} </span>
                 ...
                 <div>
                   <div class="card">
                     ...
                     <div class="card-body text-end">
                       ...
                       <p class="card-text my-2 py-0">السعر: ${element.priceSalle}</p>
